    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader className="w-[80%]">
          <SheetTitle className="text-left text-sm">Welcome to the Favicon Exporter and Image Optimiser Plugin!</SheetTitle>
        </SheetHeader>
        <div className="mt-4">
          <ScrollArea className="h-[404px]">
            <div className="grid gap-4">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li className="text-sm">3. Each export of a favicon archive will cost
                  you {FAVICON_ARCHIVE_CREDITS_COST} credits.
                </li>
              </ul>
            </div>
            <div className="grid gap-4 pt-4">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li className="text-sm">2. Each archive will cost you {IMAGE_CREDITS_COST} credits. <span
                  className="inline-block font-bold text-sm ml-0.5 mt-1">(Without limiting the number of images in each archive). </span>
                </li>
              </ul>
            </div>
            <div className="grid gap-4 pt-4">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li className="text-sm flex">2. Monitor your usage and balance to ensure smooth usage of the plugin.
                </li>
