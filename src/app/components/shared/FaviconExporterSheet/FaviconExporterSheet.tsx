  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom">
        <div className="flex text-sm font-normal">Insert the following code in the <span
        ...
        <div className="flex justify-between mt-3">
          <AnimatedTooltip isOpen={isOpen}>
            <Button variant="outline" className="px-10" onClick={handleOnCopy}>Copy to clipboard</Button>
          </AnimatedTooltip>
